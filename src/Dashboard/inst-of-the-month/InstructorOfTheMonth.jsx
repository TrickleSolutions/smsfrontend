              ...
              <table className="w-full text-sm text-left text-gray-500 ">
                ...
                <tbody>
                  ...
                  <tr class="bg-white border-b " key={"dsf56df"}>
                    ...
                    <td class="px-6 py-4 font-semibold text-black">Hari</td>
                    <td class="px-6 py-4 ">{"Wev development"}</td>
                    <td class="px-6 py-4 hidden md:table-cell max-w-0 truncate">
                      <Tooltip
                        content="Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Expedita voluptas alias labore culpa laborum fugit
                      voluptates quis laboriosam repellendus omnis."
                    ...
                    <td class="px-6 py-4 hidden sm:table-cell ">Image</td>
